...
export const FASTING_PHASES: Phase[] = [
  ...
  },
  {
    ...
    koreanName: '글리코겐 소진',
    description: '간의 글리코겐이 50~70% 소진됩니다. 지방세포에서 지방산이 분해되어 혈액으로 방출되기 시작합니다. 인슐린 저항성이 개선됩니다.',
    icon: '⚙️',
    colorToken: 'phase-2',
    bgColor: '#FFF7ED',
    textColor: '#C2410C',
  },
  {
    ...
    name: 'Fat Burning',
    koreanName: '지방 연소',
    description: '글리코겐이 거의 소진되고 몸이 지방 연소 모드로 전환됩니다. AMPK 효소가 활성화되며 혈당이 식후 대비 약 20% 감소합니다.',
    icon: '🔥',
    colorToken: 'phase-3',
    bgColor: '#FEF3C7',
    textColor: '#D97706',
  ...
  },
  {
    ...
    koreanName: '성장호르몬 급증',
    description: '인간 성장 호르몬(HGH)이 최대 400% 급증합니다. 근육 보호·지방 분해·세포 재생이 촉진됩니다. IGF-1 수치는 감소하여 노화 위험 인자가 낮아집니다.',
    icon: '💪',
    colorToken: 'phase-8',
    bgColor: '#FFF7ED',
    textColor: '#EA580C',
